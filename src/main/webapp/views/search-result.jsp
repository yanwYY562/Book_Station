...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .search-header h1 { color: #333; font-size: 24px; }
        .search-header p { color: #666; margin-top: 10px; }
                ...
                <c:forEach items="${books}" var="book">
                    <div class="book-card">
                        ...
                        <div class="book-info">
                            ...
                            <a href="/books/read/${book.id}" class="read-btn">立即阅读</a>
                        </div>
                    </div>
                </c:forEach>
            </div>
