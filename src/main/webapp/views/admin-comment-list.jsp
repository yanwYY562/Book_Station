    ...
    <div class="container">
        <div class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li><a href="/admin/comments" class="active"><span class="menu-icon">💬</span> 评论管理</a></li>
            </ul>
        </div>
                    ...
                    <tbody>
                        <c:forEach items="${comments}" var="comment">
                            <tr>
                                ...
                                <td>
                                    <span class="status-badge ${comment.status == 1 ? 'status-active' : 'status-inactive'}">
                                        ${comment.status == 1 ? '显示' : '隐藏'}
                                    </span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="action-links">
                                        <a href="/admin/comments/delete/${comment.id}" class="action-link delete" onclick="return confirm('确定删除该评论吗？')">删除</a>
                                    </div>
                                </td>
                            </tr>
                        </c:forEach>
